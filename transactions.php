                    ...
                    <div class="table-responsive">
                        <form method="post" action="process_inventory.php">
                            <table class="table" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <tr>
                                        <td><input type="text" class="form-control" name="full_name" placeholder="ex: Juan Crus"></td>
                                        <td><input type="text" class="form-control" name="address" placeholder="ex: Angeles City"></td>
                                        <td><input type="text" class="form-control" name="phone_num" placeholder="ex: 04876494843"></td>
                                    </tr>
                                </tbody>
                            </table>
                            <button type="button" class="btn btn-success btn-sm float-right" onclick="addItem();">Add Item</button>
                            <br/>
                            <center>
                                <button  class="btn btn-sm btn-primary m-1" name="save" type="submit"><i class="far fa-save" ></i> Save</button>
                                <a href="inventory.php" class="btn btn-danger btn-sm m-1"><i class="fas as fa-sync"></i> Cancel</a>
                            </center>
                        </form>
                    </div>
                </div>
